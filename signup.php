...
class UserSignup {
    ...
    public function register($username, $email, $password) {
        ...
        if (empty($username) || empty($email) || empty($password)) {
            die("Please fill in all fields."); // Display error if any field is empty
        }
...
// Instantiate the UserSignup class
$signup = new UserSignup($pdo);
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Call the register method to handle signup
            ...
            <div class="row g-4">
                <div class="col-12">
                    <div class="account__content account__content--style1">
                        ...
                        <!-- account form -->
                        <form action="signup.php" method="POST" class="account__form needs-validation" novalidate>
                            <div class="row g-4">
                                ...
                                <div class="col-12 col-md-6">
                                    <div>
                                        ...
                                        <input class="form-control" type="text" name="first_name" id="first-name" placeholder="Ex. Jhon" required>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div>
                                        <label for="last-name" class="form-label">Last name</label>
                                        <input class="form-control" type="text" name="last_name" id="last-name" placeholder="Ex. Doe" required>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div>
                                        <label for="username" class="form-label">Username</label>
                                        <input type="username" class="form-control" name="username" id="username" placeholder="Choose a username" required>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div>
                                ...
                                <div class="col-12">
                                    <div class="form-pass">
                                        ...
                                        <input type="password" class="form-control showhide-pass" name="confirm_password" id="account-cpass" placeholder="Re-type password" required>
