...
// Define the AuthController class for handling login logic
class AuthController {
    ...
    public function login($email, $password) {
        ...
        if ($user && $this->user->verifyPassword($password, $user['password'])) {
            // Successful login
            $this->redirectToSuccess($user['username']);
        } else {
            echo "Invalid email or password."; // Display error if login fails
        }
    }

    // Method to handle the redirection after successful login
    private function redirectToSuccess($username) {
        header("Location: ./dashboard/html/index-2.php?username=" . urlencode($username));
        exit();
    }
}

// Initialize the PDO instance from the database connection
$pdo = $dbConnection->getPdo(); // Ensure the PDO instance is initialized here

// Check if the form is submitted
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // Initialize the AuthController with the PDO instance
    ...
    if ($email && $password) {
        ...
        echo "Please provide both email and password."; // Display error if fields are empty
    }
}
?>
...
<body>
          ...
          <div class="menu-area">
            <ul class="menu menu--style1">
              <li>
                <a href="#0">Demos </a>
                <ul class="submenu">
                  <li><a href="index.html">Home Stock</a></li>
                  <li><a href="index1-light.html">Home Stock V1<span class="style1">Light</span></a></li>
                  <li><a href="index1-dark.html">Home Stock V2<span class="style2">Dark</span> </a></li>
                  <li><a href="index-2.html">Home Crypto</a></li>
                  <li><a href="index-2-light.html">Home Crypto V1<span class="style1">Light</span></a></li>
                  <li><a href="index-2-dark.html">Home Crypto V2<span class="style2">Dark</span> </a></li>
                  <li><a href="index-3.html">Home Forex</a></li>
                  <li><a href="index-3-light.html">Home Forex V1<span class="style1">Light</span></a></li>
                  <li><a href="index-3-dark.html">Home Forex V2<span class="style2">Dark</span> </a></li>
                </ul>
              </li>
              <li>
                <a href="#0">Services</a>
  ...
  <section class="account padding-top padding-bottom sec-bg-color2">
                ...
                <div class="col-lg-12">
                    <div class="account__content account__content--style1">
                       ...
                       <div class="account__social">
                            <a href="oauth2callback.php" class="account__social-btn"><span><img src="assets/images/others/google.svg" alt="google icon"></span>
                        ...
                        <!-- account form -->
                        <form action="signin.php" method="POST" class="account__form needs-validation" novalidate>
                            <div class="row g-4">
                                <!-- <div class="col-12">
                                    <div>
                                ...
                                <div class="col-12">
                                    <div>
                                        ...
                                        <input type="email" class="form-control" id="account-email" name="email" placeholder="Enter your email" required>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-pass">
                                        <label for="account-pass" class="form-label">Password</label>
                                        <input type="password" class="form-control showhide-pass" id="account-pass" name="password" placeholder="Password" required>
    ...
    <div class="account__shape">
        <span class="account__shape-item account__shape-item--1"><img src="assets/images/contact/4.png" alt="shape-icon"></span>
    </div>
</section>
